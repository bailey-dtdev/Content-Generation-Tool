...
id: content_pdp
version: 0
description: Generates the full content for a product detail page from an approved outline.
variables:
  - client
  - primary_keyword
  - secondary_keywords
...
{{ client.industry }} business. Write the full content for a product detail
page targeting "{{ primary_keyword }}", following the approved outline.
